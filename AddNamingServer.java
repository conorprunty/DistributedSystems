...
public class AddNamingServer{
	...
	public static void main (String args[]) {
		try{
			...
			nc[0] = new NameComponent("Add", "Context");
			NamingContext AddCtx = rootCtx.bind_new_context(nc);
			System.out.println("Context 'Add' added to Name Space.");

			nc[0] = new NameComponent("Number", "Object");
			//NameComponent path[] = {nc};
			//Binding the name to an object that is stored in the Naming Context
			AddCtx.rebind(nc, addRef);
			System.out.println("Object 'Add' added to Add Context.");
            
            //**********************************************************//
            
            nc[0] = new NameComponent("Add2", "Context");
			NamingContext Add2Ctx = rootCtx.bind_new_context(nc);
			System.out.println("Context 'Add2' added to Name Space.");

			nc[0] = new NameComponent("Number2", "Object");
			Add2Ctx.rebind(nc, Add2Ctx);
            Add2Ctx.rebind(nc, addRef);
			System.out.println("Object 'Number2' added to Number2 Context.");
            
            //**********************************************************//
            
            nc[0] = new NameComponent("Add3", "Context");
			NamingContext Add3Ctx = rootCtx.bind_new_context(nc);
			System.out.println("Context 'Add3' added to Name Space.");

			nc[0] = new NameComponent("Add3", "Object");
			Add3Ctx.rebind(nc, Add3Ctx);
			System.out.println("Object 'Add3' added to Add3 Context.");

			nc[0] = new NameComponent("Add31", "Context");
			NamingContext Add4Ctx = Add3Ctx.bind_new_context(nc);
			System.out.println("Context 'Add31' added to Add3 context.");
